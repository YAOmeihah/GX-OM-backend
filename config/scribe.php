...
return [
    ...
    'description' => '多门店债务管理系统 RESTful API，支持门店、客户、账单、还款、附件和审计日志管理。',
    ...
    'auth' => [
        ...
        'extra_info' => '通过 <code>POST /api/login</code> 登录获取访问令牌，然后在请求头中添加 <code>Authorization: Bearer {token}</code>',
    ],
